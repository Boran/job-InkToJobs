...
The source code is on github, mssql branch, see https://github.com/Boran/job-InkToJobs/tree/mssql
...
Completed costings are transferred to C3 daily (see below)
...
- click on ink_to_c3 to start an import, takes a few minutes, in a minimised window.  
- If there is a problem, maybe the DB settings in “Setups” file are wrong. 

Schedule each morning: In the Control Panel, add a Scheduled task to run C:\ink_to_c3\InkToC3.exe every morning at 07:00 


Config: edit setups.txt
-------
...
Driver : mssqloledb
DebugLevel : 2
DispenserDatabasePath : C:\5378\5378_2007BE.mdb 
point to DB, and 5378 directory
